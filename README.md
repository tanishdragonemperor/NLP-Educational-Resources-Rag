...
4. **Add your PDF files:**
   ...
   - Example: `data/Lecture_15.pdf` or `data/Lecture 15.pdf`
...
- **File Names**: Make sure PDF filenames match exactly (including spaces vs underscores) when referencing them in code.
...
- **Solution**: Use `git pull --no-rebase` or `git pull --rebase` to reconcile branches, then push your changes.
